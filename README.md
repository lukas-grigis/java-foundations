<p align="center">
  ...
  <img src="https://img.shields.io/badge/bricks-3-2E8B57" alt="3 bricks">
...
(Java 27, Maven 3). Two bricks name their JDKs in their own mise tasks, independent of the root
toolchain: `jdk27-defaults` runs the same classes on JDK 26.0.1 and 27.0.0, and
`structured-concurrency` is pinned to JDK 27.0.0 with `--enable-preview`.
